...
En LIMA hemos creado un ranking privado para poder competir entre nosotros.
Si quieres participar, solo tienes que crearte [una cuenta](https://adventofcode.com/2025/auth/login).
Una vez que estés registrado, puedes acceder a la sección `[Leaderboards]` e introducir el siguiente código:
